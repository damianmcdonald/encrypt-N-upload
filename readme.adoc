...
* obfuscate `securityutils.js`. This script file contains sensitive information and it should be as difficult for a human to read as possible. You can see the difference between the https://github.com/damianmcdonald/encrypt-N-upload/blob/master/src/main/resources/static/js/securityutil.js[non obfuscated] and obfuscated //TODO: link versions of the files.
...
The complete file can be viewed at; //TODO: insert link
