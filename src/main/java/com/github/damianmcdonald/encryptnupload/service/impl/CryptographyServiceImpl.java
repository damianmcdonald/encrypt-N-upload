...
public class CryptographyServiceImpl implements CryptographyService {
  ...
  private final static String[] LETTER_CIPHERS = new String[] {
  ...
  @Override
  public String generateHash(final String textToHash) throws NoSuchAlgorithmException {
  ...
  @Override
  public String decrypt(final String textToDecrypt, final String[] phraseParts, final String salt,
      final String iv) throws NoSuchAlgorithmException, NoSuchPaddingException,
