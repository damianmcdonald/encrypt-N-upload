...
public abstract class EncryptNUploadApplicationTestData {
  ...
  protected final static String FILEPATH = uriToFile().getAbsolutePath();
  protected final static String FILENAME = uriToFile().getName();
  ...
  protected final static String[] PASSPHRASE_USERNAME = new String[] {
      "Hm", "*s", "*2", "rD", "+J", "3X", "zZ", "$L", "LP", "Yq"
    };
  ...
  protected final static String[] PASSPHRASE_PASSWORD = new String[] {
    "n4", "Yq", "Hm", "3X", "W^", "8@", "Lt", "Ps", "Hm", "L$"
    };
  protected final MediaType CONTENT_TYPE = new MediaType(
  ...
  protected static File uriToFile() {
    File f = null;
    try {
